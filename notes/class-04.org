...
- Please please keep giving me feedback and contributing learning
  ...
  your feedback (I feel like Tuesday could be a breakthrough). Within
  active learning, there are so many knobs to tune (for example
  structure), and these can be tailored to each group and individual .
